...
public class TestInsertExercise {
	...
	ArrayList<Sentence> sentencesEmpty;
	...
	public void setUp(){
		...
		// Da die schwirigkeit bei der GUI überprüft wir ist hier kein Problem zu erwarten
	...
	/**
	 * Löscht die Daten die in den Test erstellt wurden um so die 
	 * Datenbank sauber zu halten
	 * @return
	 * @throws SQLException
