...
import de.uhd.ifi.se.quizapp.model.init.InitDatabase;
...
public class TestGetExerciseSuper {
	...
	*/
	...
	/** At the moment the Database has to be consistend
	protected void removeDataBase() {

		Path path = Paths.get(new File("").getAbsolutePath(), "WebContent", "db", "heieducation.sqlite");
