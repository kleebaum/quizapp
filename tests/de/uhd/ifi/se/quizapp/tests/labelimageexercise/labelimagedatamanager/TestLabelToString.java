...
public class TestLabelToString extends LabelImageDataTestingSuper{
	...
	public void testLabelsToStringNull(){
		...
		this.dataManager.labelsToString(labels);
	}
	
	@Test
	public void testLabelsToStringEmpty(){
		ArrayList<ImageLabel> labels=new ArrayList<ImageLabel>();
		assertEquals("[]",this.dataManager.labelsToString(labels));		
	}
	...
	public void testLabelsToStringFilled(){
		...
		labels.add(label);
		assertEquals(expected,this.dataManager.labelsToString(labels));
	}
	...
	public void testLabelsToStringFilledMore(){
		...
		labels.add(label1);
		labels.add(label2);
		assertEquals(this.dataManager.labelsToString(labels),expected);
	}
}
